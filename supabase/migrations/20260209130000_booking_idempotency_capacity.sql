BEGIN;
-- Booking idempotency + capacity enforcement
...
-- Recreate booking function with idempotency + room capacity guard
...
GRANT EXECUTE ON FUNCTION public.create_booking_v4(
    UUID, UUID, UUID, UUID, DATE, DATE, NUMERIC, NUMERIC, TEXT, TEXT, TEXT,
    TEXT, TEXT, TEXT, NUMERIC, INTEGER, NUMERIC, TEXT, BOOLEAN
) TO authenticated;
GRANT EXECUTE ON FUNCTION public.create_booking_v4(
    UUID, UUID, UUID, UUID, DATE, DATE, NUMERIC, NUMERIC, TEXT, TEXT, TEXT,
    TEXT, TEXT, TEXT, NUMERIC, INTEGER, NUMERIC, TEXT, BOOLEAN
