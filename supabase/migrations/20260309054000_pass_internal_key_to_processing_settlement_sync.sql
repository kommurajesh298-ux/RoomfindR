-- Pass the service-role key through the request body as a fallback for
-- pg_net-triggered Edge Function calls where gateway headers are not exposed
-- to the function runtime consistently.
