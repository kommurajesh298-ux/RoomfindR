-- Restore automatic payout reconciliation for processing settlements.
-- The older cron job targets a retired internal path, so processing payouts
-- can remain stuck unless a webhook arrives or someone manually reconciles them.
