BEGIN;
-- Only block booking creation if the customer already has a PAID active stay in the same PG.
-- This prevents stale/pending payment attempts from blocking new bookings.
